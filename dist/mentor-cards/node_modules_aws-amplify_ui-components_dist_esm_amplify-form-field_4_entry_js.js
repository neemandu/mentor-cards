"use strict";
(self["webpackChunkmentor_cards"] = self["webpackChunkmentor_cards"] || []).push([["node_modules_aws-amplify_ui-components_dist_esm_amplify-form-field_4_entry_js"],{
...
const AmplifyFormField = class {
    ...
    render() {
        return ((0,_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "form-field" }, this.label && ((0,_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "form-field-label" }, (0,_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__.h)("amplify-label", { htmlFor: this.fieldId }, this.label))), this.description && ((0,_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { id: `${this.fieldId}-description`, class: "form-field-description", "data-test": "form-field-description" }, this.description)), (0,_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, (0,_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", { name: "input" }, (0,_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__.h)("amplify-input", { fieldId: this.fieldId, description: this.description, type: this.type, handleInputChange: this.handleInputChange, placeholder: this.placeholder, name: this.name, value: this.value, inputProps: this.inputProps, disabled: this.disabled }))), this.hint && (0,_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__.h)("amplify-hint", { id: `${this.fieldId}-hint` }, this.hint)));
    }
};
...
const AmplifyHint = class {
    ...
    render() {
        return ((0,_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "hint" }, (0,_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null)));
    }
};
...
const AmplifyInput = class {
    constructor(hostRef) {
        ...
        /** (Optional) The placeholder for the input element.  Using hints is recommended, but placeholders can also be useful to convey information to users. */
        this.placeholder = '';
        this.formSubmit = (0,_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__.c)(this, "formSubmit", 7);
    }
...
const AmplifyLabel = class {
    ...
    render() {
        return ((0,_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", { class: "label", htmlFor: this.htmlFor }, (0,_index_39969785_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null)));
    }
};
