"use strict";
(self["webpackChunkmentor_cards"] = self["webpackChunkmentor_cards"] || []).push([["node_modules_aws-amplify_ui-components_dist_esm_amplify-s3-album_entry_js"],{
...
/* harmony import */ var _aws_amplify_core__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @aws-amplify/core */ 75582);
...
/* harmony import */ var _storage_types_f257c0f2_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./storage-types-f257c0f2.js */ 4602);
...
/* harmony import */ var _aws_amplify_storage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @aws-amplify/storage */ 37484);
/* harmony import */ var _storage_helpers_48c373a0_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./storage-helpers-48c373a0.js */ 21646);
...
const logger = new _aws_amplify_core__WEBPACK_IMPORTED_MODULE_7__.ConsoleLogger('S3Album');
const AmplifyS3Album = class {
  constructor(hostRef) {
    ...
    this.pickerText = _Translations_3f32c42a_js__WEBPACK_IMPORTED_MODULE_3__.T.PICKER_TEXT;
    this.albumItems = [];
    this.imgArr = {};
    this.list = /*#__PURE__*/(0,C_Users_Sampath_Music_mentor_cards_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
      const {
        path = '',
        level,
        track,
      ...
      if (!_aws_amplify_storage__WEBPACK_IMPORTED_MODULE_5__.Storage || typeof _aws_amplify_storage__WEBPACK_IMPORTED_MODULE_5__.Storage.list !== 'function') {
        throw new Error(_constants_d1abe7de_js__WEBPACK_IMPORTED_MODULE_4__.e);
      }

      try {
        const data = yield _aws_amplify_storage__WEBPACK_IMPORTED_MODULE_5__.Storage.list(path, {
          level,
          track,
          identityId
        });
    ...
    this.marshal = list => {
      list.forEach(item => {
        ...
        if (_storage_helpers_48c373a0_js__WEBPACK_IMPORTED_MODULE_6__.i.has(ext)) {
    ...
    this.handlePick = /*#__PURE__*/function () {
      var _ref2 = (0,C_Users_Sampath_Music_mentor_cards_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (event) {
        ...
        const key = path + (0,_storage_helpers_48c373a0_js__WEBPACK_IMPORTED_MODULE_6__.c)(file, fileToKey);

        try {
          yield (0,_storage_helpers_48c373a0_js__WEBPACK_IMPORTED_MODULE_6__.p)(key, file, level, track, file['type'], logger);
        } catch (error) {
          logger.error(error);
  ...
  getContentType(item) {
    return (0,_aws_amplify_core__WEBPACK_IMPORTED_MODULE_8__.filenameToContentType)(item.key, 'image/*');
  }
  ...
  render() {
    return (0,_index_39969785_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", null, (0,_index_39969785_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "album-container"
    }, (0,_index_39969785_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "grid-row"
    }, this.albumItems.map(item => {
      return (0,_index_39969785_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
        class: "grid-item",
        key: `key-${item.key}`
      }, (0,_index_39969785_js__WEBPACK_IMPORTED_MODULE_1__.h)("amplify-s3-image", {
    ...
    }))), this.picker && (0,_index_39969785_js__WEBPACK_IMPORTED_MODULE_1__.h)("amplify-picker", {
      pickerText: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_9__.I18n.get(this.pickerText),
...
//# sourceMappingURL=node_modules_aws-amplify_ui-components_dist_esm_amplify-s3-album_entry_js.js.map