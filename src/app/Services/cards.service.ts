...
export class CardsService {
  ...
  favorites: any[] = [];
  categoriesOrder: string[] = ['ערכות להתנסות חופשית', 'ערכות חדשות', 'VIP ערכות', 'ערכות VIP', 'נעים להכיר', 'קלפי תמונה', 'הייטק', 'שיתופי פעולה', 'קלפי שאלות', 'קלפי חגים', 'קלפי מילה', 'קלפי תמונה + מילה', 'קלפי מסרים', 'קלפי ערכים', 'ערכות במתנה', 'קלפי NLP', 'NLP קלפי'];
