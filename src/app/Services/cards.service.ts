...
export class CardsService {
  ...
  favorites: any[] = [];
  categoriesOrder: string[] = ['החמישייה הפותחת', 'VIP ערכות', 'ערכות VIP', 'קלפי תמונה', 'הייטק', 'שיתופי פעולה', 'קלפי שאלות', 'קלפי חגים', 'קלפי מילה', 'קלפי תמונה + מילה', 'קלפי מסרים', 'קלפי ערכים', 'ערכות במתנה', 'קלפי NLP', 'NLP קלפי'];
